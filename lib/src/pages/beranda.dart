import 'package:fitness_ui/src/pages/screens/my_food/my_food_screen.dart';
import 'package:flutter/material.dart';

import '../config/theme/fitness_app_theme.dart';
import '../models/tabIcon_data.dart';
import '../views/bottom_navigation_view/bottom_bar_view.dart';
          ...
          changeIndex: (int index) {
            ...
            if (index == 0 || index == 0) {
              ...
              animationController?.reverse().then<dynamic>((data) {
                ...
                setState(() {
                  tabBody =
                      MyFoodScreen(animationController: animationController);
                });
              });
            }
          },
